...
[ -f /etc/nginx/sites-enabled/GenoPlotter ] && sudo rm /etc/nginx/sites-enabled/GenoPlotter
...
npm install --prefix ${GENOPLOTTER_DIR}/js/api express@5.2.1 cors@2.8.6 @gmod/bbi@11.2.3 @gmod/range-cache-filehandle@1.4.0
